...
export class TodoController implements OnModuleInit {
  ...
  constructor(@Inject(TodoProto.TODO_PACKAGE_NAME) private client: ClientGrpc) {
  }

  onModuleInit() {
    this.todoService = this.client.getService<TodoProto.TodoServiceClient>(TodoProto.TODO_SERVICE_NAME);
  }
